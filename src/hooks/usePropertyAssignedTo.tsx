...
import {AssignsPropertiesPropsFragment} from "../generated/types";
...
type UsePropertyAssignedToProps = {
    relationships: AssignsPropertiesPropsFragment[],
    emptyMessage: string
}

const usePropertyAssignedTo: FC<UsePropertyAssignedToProps> = (props) => {
...
export default usePropertyAssignedTo;
